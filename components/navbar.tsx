...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline:
      "bg-white/80 dark:bg-black/80 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 hover:bg-white dark:hover:bg-black focus:ring-gray-300 dark:focus:ring-gray-600 backdrop-blur-sm",
  };
...
const MobileMenu: React.FC<MobileMenuProps> = ({
  ...
  <div
    className={`
      md:hidden fixed top-20 left-0 w-full bg-white/95 dark:bg-black/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-700 shadow-2xl
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden flex items-center space-x-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-xl text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-orange-500 transition-all duration-300"
